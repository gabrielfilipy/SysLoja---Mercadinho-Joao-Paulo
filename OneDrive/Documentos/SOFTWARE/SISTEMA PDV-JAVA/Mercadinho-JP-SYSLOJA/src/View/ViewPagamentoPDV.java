...
public class ViewPagamentoPDV extends javax.swing.JDialog {
    ...
    float desconto, subTotal, recebido=0, pagar, troco;
    ...
    tfTroco.setText(formatador.arredondamentoValoresFloat(troco));   
        ...
        JOptionPane.showMessageDialog(null, "Verifique se existe vírgulas, pois o sistema só aceita pontos!");
        }
    }
    /**
    ...
    public static javax.swing.JTextField tfTroco;
